  ...
  <div class="d-grid gap-1" style="grid-template-columns: 1fr 3fr;"> <?= $sidebar;?> <div class="bg-light border rounded-3">
      ...
      <div class="maintag">
        ...
        <form class="formDesign" method="post" action="
					<?= base_url()?>add_new_product" enctype="multipart/form-data">
          <!--Product Name-->
          <div class="form-group row">
            <label for="staticEmail" class="col-sm-2 col-form-label">Name</label>
            <div class="col-sm-10">
              <input type="text" name="product_name" class="form-control" id="formGroupExampleInput" placeholder="Product Name Here" autocomplete="on">
            </div>
          </div>
          <br />
          <!--Product Catagory-->
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="activity" id="inlineRadio1" value="option1">
                <label class="form-check-label" for="inlineRadio1">Active</label>
              </div>
              <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="activity" id="inlineRadio2" value="option2">
            ...
            <div class="col-sm-10">
              ...
              <div class="bootstrap-iso">
                <div class="input-group">
                  <input class="form-control" id="date" name="lunch_date" placeholder="MM/DD/YYYY" type="date" />
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="col-sm-3">
                  <div class="form-group">
                    <select name="base_unit" class="form-control">
                      ...
                      <option>Dispenser <optio>
                    </select>
                  </div>
                </div>
                <div class="col-sm-4">
                  <input name="base_qnty_price" class="form-control" type="number" placeholder="Price per Base Quantity">
                </div>
              </div>
              <div class="form-group row">
                ...
                <div class="col-sm-4">
                  <input name="carton_price" class="form-control" type="number" placeholder="Price per Carton">
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="form-group row">
        <!--Submit Button-->
        <button type="submit" class="btn btn-primary btn-block" data-toggle="button">Submit</button>
      </div>
      <br />
     </form>
    </div>
